...
public class FollowGuidedTour : MonoBehaviour
{
    ...
    public int currentGuidedTourDestinationIndex = 1; // optionally start at a specific index
    ...
    private void Start()
    {
        ...
        {
            guidedTourObjects = new GameObject[] { guidedTourObjects[3], guidedTourObjects[29] };
        }
